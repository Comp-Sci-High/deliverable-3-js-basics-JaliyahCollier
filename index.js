...
let greeting = "Hello, my name is" + variable 
...
favoriteMovie.quote= " Run bitch, run!"
...
console.log(
    `My favorite movie is ${favoriteMovie.name}. 
    It is a ${favoriteMovie.genre} film with a rating of ${favoriteMovie.rating} stars. 
    A famous quote from the movie is: '${favoriteMovie.quote}'.`
);
